    ...
    <div id="tudo">
        ...
        <div id="content">
            ...
            <div id="areaAlterar">
                ...
                <fieldset>
                    <legend class="legend">Alterar Senha de Candidatos</legend>

                    <form name="trocaSenha" method="post" action="../controle/ControleCandidato.php?op=alterarSenha">
                        <table>
                            <tr>
                                <td>Login:</td>
                                <td>
                                    <input name="login" type="text" maxlength="45" <?php echo (isset($_SESSION['erros']) && in_array('login', $_SESSION['erros'])) ? 'class="campo_erro largura_login"' : 'class="campo largura_login"'; ?> />
                            ...
                            <tr>
                                <td>Senha Atual:</td>
                                <td>
                                    <input name="senha" type="password" maxlength="10" <?php echo (isset($_SESSION['erros']) && in_array('senha', $_SESSION['erros'])) ? 'class="campo_erro largura_login"' : 'class="campo largura_login"'; ?> />
                                </td>
                            </tr>
                            <tr>
                                <td>Nova senha:</td>
                                <td>
                                    <input name="nova_senha" type="password" maxlength="10" <?php echo (isset($_SESSION['erros']) && in_array('nova_senha', $_SESSION['erros'])) ? 'class="campo_erro largura_login"' : 'class="campo largura_login"'; ?> />
                                </td>
                            </tr>
                            <tr>
                                <td>Confirma senha:</td>
                                <td>
                                    <input name="confirma_senha" type="password" maxlength="10" <?php echo (isset($_SESSION['erros']) && in_array('confirma_senha', $_SESSION['erros'])) ? 'class="campo_erro largura_login"' : 'class="campo largura_login"'; ?> />
                                </td>
                            </tr>
                            <tr>
                                <td align="right" colspan="2">
                                    ...
                                    <?php
                                    }else if (isset($_SESSION['erros']) && in_array('senha_diferente', $_SESSION['erros'])) {
                                    ?>
                                        <span class="style1">* As senhas não coincidiram</span>
                                    <?php
