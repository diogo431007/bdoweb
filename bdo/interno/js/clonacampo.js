...
function duplicarProprietario(){  
    var clone = document.getElementById('origem_proprietario').cloneNode(true);  
    var destino = document.getElementById('destino_proprietario');  
    destino.appendChild (clone);  
...
function duplicarProprietario2(id){
    var div = 'origem_proprietario'+id;
...
function duplicarProprietario3(){
    
    var clone = document.getElementById('destino_proprietario').cloneNode(true);  
    var destino = document.getElementById('destino_proprietario');  
    destino.appendChild (clone);  
...
function removerProprietario(id){  
    var node1 = document.getElementById('destino_proprietario');
    node1.removeChild(node1.childNodes[0]);
}