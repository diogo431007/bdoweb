...
class Email{
    ...
    public static function enviarEmail($paraEmail,
        ...
        $msg .= "\nPrefeitura Municipal de Canoas<br/>SMDE<br/><a href='http://sistemas.canoas.rs.gov.br/bancodeoportunidades/' target='_blank' style='color: #000; font-weight: bold;'>Banco de Oportunidades</a><br><br>";
	...
	$headers .= "From: ".$remetenteNome." <".$remetenteEmail.">".$quebra_linha;
        ...
        if(!mail($paraEmail, $assunto, $msg, $headers ,"-r".$remetenteEmail)){ // Se for Postfix
            $headers .= "Return-Path: " . $remetenteEmail . $quebra_linha; // Se "não for Postfix"
            mail($paraEmail, $assunto, $msg, $headers);
	}
//   
    }
}
